	       ...
	       else
	       {
	    	  ...
	    	  if(!img.isEmpty()) //check whether the img is empty if its not
	    	  {
	    		  try {
	    			  ...
	    			  String rootPath = "C:\\Users\\yashm\\"; //define desktop path
		  			  File dir = new File(rootPath +"ePortal\\src\\main\\webapp\\resources\\img\\category");//save the uploaded img in this folder
